...
public class AutoTellerMachine{
	...
	public static void Deposit(){
		...
		System.out.println("Would you like to deposit money in your Saving or Checking Account?");
		System.out.println("Enter 0 for Checking and 1 for Savings");
		depositnum = depositscan.nextInt();
		if (depositnum == 0){
		...
		System.out.println("Deposit Complete! Your Balance is now "  /* + CustomerBalance*/);
