...
public class Bank{
	...
	public static void banque() {
		...
		//Page Selection 
				...
				System.out.println("Welcome to the Vito Bank! Our Branch Number is " + branchNumber + "!");
			...
			if (page.equalsIgnoreCase("Help")) {
				...
				System.out.println("Balance - Balance and transfer, deposit, and withdraw");
