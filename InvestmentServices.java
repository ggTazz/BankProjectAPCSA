...
{
    private static double CVSHealth = 74.20;
    private static double Apple = 279.50;
    private static double MicroSoft = 154.89;
    private static double Disney = 148.08;
    private static double McDonald's = 198.16;
    private static double Nvidia = 227.00;
    private static double Visa = 185.51;
    private static double AT&T = 38.64;
    private static double Verizon = 61.45;
    private static double FedEx = 164.25;
    double commissionFee = 12.99;
    public static double BuySellStocks(int comapanyName, int shareNumbers, double stockPrice, double commissionFee)
    {
