...
{
    public static double CVSHealth = 74.20;
    public static double Apple = 279.50;
    public static double MicroSoft = 154.89;
    public static double Disney = 148.08;
    public static double McDonald's = 198.16;
    public static double Nvidia = 227.00;
    public static double Visa = 185.51;
    public static double AT&T = 38.64;
    public static double Verizon = 61.45;
    public static double FedEx = 164.25;
    public static double commissionFee = 12.99;
    public static double BuySellStocks(int comapanyName, int shareNumbers, double commissionFee)
    {
        return shareNumbers * companyName + (companyName * commissionFee);
    }
