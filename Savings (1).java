...
public class Savings
{
    ...
    public static void main(String[] args) {
        ...
        if(!isValid){
            System.out.println("***** TRANSACTION IS COMPLETE!!....THANK YOU ... HAVE A NICE DAY*****");
        }
    ...
    public static boolean savingsAccount(){
        ...
        if(!accountExist){
            ...
            if(userChoice.equals("D") || userChoice.equals("d")
                || userChoice.equals("W") || userChoice.equals("w")
                || userChoice.equals("B") || userChoice.equals("b")
                || userChoice.equals("E") || userChoice.equals("e")){
                doBankingTransaction(userChoice);
            }
            else{
    ...
    public static boolean checkAccountExists(String accNr){
       ...
       for(String key : accountBalance.keySet()){
           String accountinBank = key;
           if(accountinBank.equals(accNr)){
               accountExist = true;
               break;
           }
       }
    ...
    // All of banking transactions based on user choice
    public static boolean doBankingTransaction(String userChoice){
        boolean status = true;
        if(userChoice.equals("D") || userChoice.equals("d"))
            {
